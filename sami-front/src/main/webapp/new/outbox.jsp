			...
			<div class="top-nav-inner">
				<div class="nav-header">
					...
					<a href="index.html" class="brand"> <i class="fa fa-database"></i><span
						class="brand-name">SIMPLIFY ADMIN</span>
					</a>
				</div>
			...
			<div class="sidebar-inner scrollable-sidebar">
				<div class="main-menu">
					<ul class="accordion">
						...
						<li class="bg-palette1 active"><a href="inbox.html"> <span
								class="menu-content block"> <span class="menu-icon"><i
		...
		<div class="main-container sidebar-mini">
			<div class="inbox-wrapper">
				...
				<div class="inbox-body padding-md">
					...
					<div class="message-table table-responsive" style="margin-bottom: 50px; border-style: none; background-color: #f5f5f5;">
									...
									<form>
										...
										<div class="form-group">
											<label for="exampleInputPassword1">内容</label> <input
												...
												name="content" id="exampleInputPassword1" placeholder="content">
										</div>
										<!-- /form-group -->
