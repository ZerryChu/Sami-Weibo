								...
								<div class="panel-body paddingTB-sm">
									<ul>
										...
										<li><a href="inbox.html"> <i
												class="fa fa-inbox fa-lg"></i><span class="m-left-xs">Inboxes</span>
				...
				<div class="row">
					<div class="col-md-10">
						<div class="timeline-wrapper clearfix">
							...
							<div id="receive_msg" class="timeline-year bg-purple"></div>
								...
								<div class="timeline-item">
									...
									<div class="timeline-item-inner">
										<div class="timeline-body">
											...
											<div class="pagination-row clearfix m-bottom-md" style="margin-top: 10px; margin-bottom: 0px;">
												<div class="pull-right pull-left-sm">
													<div id="page" class="inline-block vertical-middle m-right-xs">Page
														1 of 8</div>
													<ul class="pagination vertical-middle" style="margin: 0px;">
									...
									<div class="timeline-item-inner">
										<div class="timeline-body">
											...
											<div class="timeline-content">
												...
												<small class="block text-muted m-bottom-xs">27 July,
													2014, 07:24</small> Lorem ipsum dolor sit amet, consectetur
