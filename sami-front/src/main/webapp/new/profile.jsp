				...
				<div class="top-nav-inner">
					<div class="nav-header">
						...
						<a href="index.html" class="brand">
							<i class="fa fa-database"></i><span class="brand-name">SAMI WEIBO</span>
						</a>
					</div>
						...
						<ul class="accordion">
							...
							<li class="openable bg-palette3 open">
								...
								<ul class="submenu">
									...
									<li class="active"><a href="profile.html"><span class="submenu-label">Profile</span></a></li>
						...
						<div class="col-md-3 user-profile-sidebar m-bottom-md">
							<div class="row">
								...
								<div class="col-sm-6 col-md-12">
									<div id="usr_nickname" class="user-name m-top-sm">Jane Doe<i class="fa fa-circle text-success m-left-xs font-14"></i></div>
														...
														<div class="row m-top-md">
															<div class="col-sm-6">
																<div class="widget-stat3 bg-primary">
																	...
																	<h3 id="following" class="no-margin">5123</h3>
																</div>
															</div><!-- ./col -->
															<div class="col-sm-6">
																<div class="widget-stat3 bg-info">
																	...
																	<small id="follower" class="text-upper">Follower</small>
