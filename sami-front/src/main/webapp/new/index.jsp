...
<body class="overflow-hidden">
	<div class="wrapper preload">
			...
			<div class="sidebar-inner scrollable-sidebar">
				<div class="main-menu">
					<ul class="accordion">
						...
						<li class="bg-palette1 active"><a href="index.html"> <span
						...
						<li class="openable bg-palette3"><a href="#"> <span
								class="menu-content block"> <span class="menu-icon"><i
									...
									class="text m-left-sm">微博圈子</span> <span class="submenu-icon"></span>
						...
						<li class="openable bg-palette4"><a href="#"> <span
								class="menu-content block"> <span class="menu-icon"><i
									...
									class="text m-left-sm">标签</span> <span class="submenu-icon"></span>
						...
						<li class="openable bg-palette3"><a href="#"> <span
								class="menu-content block"> <span class="menu-icon"><i
									...
									class="text m-left-sm">话题</span> <span class="submenu-icon"></span>
		...
		<footer class="footer">
			<span class="footer-brand"> <strong class="text-danger">Sami</strong>
				Weibo
			</span>
			<p class="no-margin">
