			...
			success : function(data) {
				...
				while (data.returndata[i] != undefined) {
					...
					if (data.returndata[i].is_target == false) {
						str += "<div class=\"content\"><div class=\"user_msg\"><img class=\"user_icon\" src=\"pic/" + $.query.get("username") + ".jpg\">";
						...
						str += "<div class=\"target_content\"><div class=\"target_msg\"><img style=\"float: right;\" class=\"user_icon\" src=\"pic/" + $.query.get("targetUsername") + ".jpg\">";
						str += "<div style=\"float: right\" class=\"name\">";
