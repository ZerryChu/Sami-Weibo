...
.subscribe {
	background: rgba(0, 0, 0, 0) url("images/icon4-24.png?016") no-repeat scroll 0px -526px;
    padding-left: 26px;
    text-align: left;
    margin-right: 1px;
}
...
<body>
		...
		<div class="left_content">
			...
			<div align="center" class="heated_label">
				<div class="search" style="float: right;">
					...
					<button class="subscribe" style="float: right; color: gray;">订阅</button>
				</div>
				<table>
					<!--  <tr align="right">
					...
					<tr>
						<td><div id="lb0" class="label_info">
								<div
									...
									<div align="center" class="label_name"></div>
								</div>
							</div></td>
			...
			<div id="messages">
				...
				<div class="messages_class">
					<ul>
						...
						<li class="" style=""font-weight:bold;"></li>
						<li class="" style=""font-weight:bold;"></li>
						<li class="" style=""font-weight:bold;"></li>
						<li class="" style=""font-weight:bold;"></li>
						<li class="" style=""font-weight:bold;"></li>
	...
	<script type="text/javascript">
									...
									.each(
											...
											function() {
												...
												while (data.rec[i] != undefined) {
													...
													$(id)
															.append(
																	"<span id=\"l_icon\" class=\"icon\"></span><a style=\"text-decoration:none; color: gray;\" href=\"label.jsp?username="
																			+ $.query
																					.get("username")
																			+ "&userToken="
																			+ $.query
		...
		$(".send_msg").live(
				'click',
				function() {
					var item = "#master" + $(this).parent().attr("id").substr(1);
		...
		$(".master_info").click(
				function() {
					var targetNickname = $(this).find(".master_nickname")
							.text();
				...
				.mouseenter(
						function() {
							...
							if ($(temp).length > 0) {
								...
								str += "<button id=\"focus\" style=\"float: right;margin: 3%;\">关注</button>";
